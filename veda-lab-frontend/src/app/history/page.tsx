        ...
        <main className="flex-1 flex flex-col overflow-hidden relative z-10 bg-[#050505]">
            ...
            <div className="flex-1 overflow-y-auto p-12 max-w-6xl mx-auto w-full custom-scrollbar">
                ...
                <div className="space-y-6">
                    {true ? (
                        <div className="text-center py-20 text-gray-500 font-mono text-sm tracking-widest uppercase italic border border-white/5 rounded-3xl bg-white/[0.02]">
                            No chronicles found. Initialize a neural synthesis.
                        </div>
                    ) : (
                        ([] as any[]).map((chat: any, i: number) => (
