...
echo [2/3] Starting Veda Server (Localhost:3000)...
echo    - This powers the Code Studio ^& Chat.
echo    - DO NOT CLOSE THE SERVER WINDOW that pops up!
start "Veda Server" cmd /k "cd /d %~dp0 && node server/index.js"
timeout /t 4 >nul
...
echo      SYSTEM ONLINE
echo ==================================================
echo 1. If Code Studio says "Offline", check the "Veda Server" window for errors.
